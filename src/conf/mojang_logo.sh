...
__stack './assets/minecraft/textures/gui/title/mojang__.png' './assets/minecraft/textures/gui/title/mojang_.png' './assets/minecraft/textures/gui/title/mojang.png'
